/* Certain combinations are not possible, because there is not enough flash memory available on the ATmega328. Example: The Scania V8 Idle startup file
...
// Engine RPM range
#define TOP_SPEED_MULTIPLIER 30 // RPM multiplier: the bigger the number the larger the rev range, 20 - 30 is a good place to start
